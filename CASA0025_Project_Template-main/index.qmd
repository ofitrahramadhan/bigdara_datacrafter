...
- Afterwards, the Yield data is obtained from the [United States Department of Agriculture](https://quickstats.nass.usda.gov/) for each of the years and a final dataset is obtained which has all the X Variables (GEOID,NDVI,PA,SAR,SMS_AM,LST_DAY,SMS_PM,LST_NIGHT,PAR,ET) ) & Y variable (YIEL.D
)
```pyth
    # Commented the line below as I have installed the gee api alreadyon
  # #pip install earthengine-api
    ...
    def processYear(year):
        ...
        #`NDVI` parameter of the datasex and we obtain the mean over the growth period of the crop
        ...
        #`soil_moisture_am` & `soil_moisture_pm`parameter of the dataset which provides 'Retrieved soil moisture estimate from t
        # e disaggregated/downscaled vertical polarization brightness temperature at 9-km grid cell one at AM overpass & other at  PM overpas s.in dB.
        ...
        # & Daytime Land Surface Temperature' both in Kelvin (K).
        ...
        #`GMT_1200_PAR` parameter of the dataset which provides 'Total PAR at GMT 12:00'.PAR is incident solar radiation 
        # n the visible spectrum (400-700 nanometers) and is an important variable in land-surface models having use in agriculture
        ...
        Cncommeednt the line bel o as I have got the data in my drivalreadye 
