...
Datasets that we have used from Google Earth Engine:-
- **United States Census Bureau TIGER Dataset**
- **USDA NASS Cropland Data Layers**
- **MOD13Q1.061 Terra Vegetation Indices 16-Day Global**
- **GRIDMET:Gridded Surface Meteorological Dataset**
- **SPL3SMP_E.005 SMAP L3 Radiometer Global Daily 9km Soil Moisture**
- **MOD11A1.061 Terra Land Surface Temperature**
- **MCD18C2.061 Photosynthetically Active Radiation Daily 3 hour**
- **MOD16A2GF.061: Terra Net Evapotranspiration**

Datasets used from other sources:-
- **Crop Yield Data**
  It includes county-wise crop yield data. Provider : [United States Department of Agriculture](https://quickstats.nass.usda.gov/)
- **Current Crop Price Data**
  We use the Financial Times current crop price data. Provider: [Financial Times](https://markets.ft.com/data/commodities)
