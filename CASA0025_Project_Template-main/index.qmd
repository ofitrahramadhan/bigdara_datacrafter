...
- **A1 - United States Census Bureau TIGER Dataset**: Includes boundary information for U.S. counties.
- **A2 - USDA NASS Cropland Data Layers**: Provides crop-specific land cover data layers.
- **A3 - MOD16A2GF.061 Terra Net Evapotranspiration**: Measures the total evapotranspiration over land.
- **A4 - MOD11A1.061 Terra Land Surface Temperature**: Captures daily land surface temperature data.
- **A5 - MOD13Q1.061 Terra Vegetation Indices 16-Day Global**: Offers 16-day global vegetation indices.
- **A6 - GRIDMET: Gridded Surface Meteorological Dataset**: Delivers high-resolution meteorological data.
- **A7 - MCD18C2.061 Photosynthetically Active Radiation Daily 3 hour**: Provides estimates of solar radiation.
- **A8 - SPL3SMP_E.005 SMAP L3 Radiometer Global Daily 9km Soil Moisture**: Reports global daily soil moisture.
- **A9 - Crop Yield Data**: Contains county-wise crop yield data. Provider: [United States Department of Agriculture](https://quickstats.nass.usda.gov/)
- **A10 - Current Crop Price Data**: Uses current crop price data from the Financial Times. Provider: [Financial Times](https://markets.ft.com/data/commodities)
